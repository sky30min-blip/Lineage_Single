...
public class autohuntreset extends ItemInstance {
	...
	public void toClick(Character cha, ClientBasePacket cbp) {
		...
		if (cha.getInventory() != null) {
			...
			ChattingController.toChatting(cha, String.format("자동사냥 %s 충전 되었습니다.", Util.convertSecondsToMinutes(this.getItem().getSmallDmg())), Lineage.CHATTING_MODE_MESSAGE);
