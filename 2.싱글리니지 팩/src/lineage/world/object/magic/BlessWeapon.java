...
public class BlessWeapon extends Magic {
	...
	public void toBuffEnd(object o) {
		...
		if (o instanceof ItemInstance) {
			...
			if (weapon.isEquipped() && weapon.getCharacter()!=null && !weapon.getCharacter().isWorldDelete()) {
				...
				ChattingController.toChatting(weapon.getCharacter(), "\\fY블레스 웨폰 종료", Lineage.CHATTING_MODE_MESSAGE);
			}
		}
	}
	...
	public void toBuff(object o) {
		if(o instanceof ItemInstance && getTime() == Lineage.buff_magic_time_max || getTime() == Lineage.buff_magic_time_min){
			ItemInstance weapon = (ItemInstance)o;
			if(weapon.isEquipped() && weapon.getCharacter()!=null && !weapon.getCharacter().isWorldDelete()){
				ChattingController.toChatting(weapon.getCharacter(),"\\fY블레스 웨폰: " + getTime() + "초 후 종료", Lineage.CHATTING_MODE_MESSAGE);
			}
		}
	}
	...
	static public void onBuff(object o, Skill skill) {
		...
		ChattingController.toChatting(weapon.getCharacter(), "블레스 웨폰: 착용중인 무기 근거리 대미지+2, 근거리 명중+2", Lineage.CHATTING_MODE_MESSAGE);
	}
