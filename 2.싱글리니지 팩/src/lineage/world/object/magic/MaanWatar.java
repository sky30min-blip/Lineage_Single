...
public class MaanWatar extends Magic {
	...
	public void toBuffEnd(object o) {
		...
		if (o instanceof Character) {
			...
			// 정령 내성-5%
			cha.setDynamicElfResist(cha.getDynamicElfResist() - 0.05);
			ChattingController.toChatting(o, "\\fY수룡의 마안 종료", Lineage.CHATTING_MODE_MESSAGE);
		}
	}
	...
	public void toBuff(object o) {
		if (getTime() == Lineage.buff_magic_time_max || getTime() == Lineage.buff_magic_time_min)
			ChattingController.toChatting(o, "\\fY수룡의 마안: " + getTime() + "초 후 종료", Lineage.CHATTING_MODE_MESSAGE);
	}

	static public void init(object o, int time) {
		BuffController.append(o, MaanWatar.clone(BuffController.getPool(MaanWatar.class), SkillDatabase.find(615), time));
	}
	...
	static public void init(Character cha, Skill skill) {
		...
		ChattingController.toChatting(cha, "수룡의 마안: 일정 확률로 받는 마법 대미지가 50% 감소, 정령 내성+5%", Lineage.CHATTING_MODE_MESSAGE);
	}
}
