...
public class Joel extends object {
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp) {
		...
		if (pc.getLawful() < Lineage.NEUTRAL)
			...
			pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "Joel1"));
	}
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
		...
		if (action.equalsIgnoreCase("request adena10")) {
			if (pc.getInventory().find("뼈조각") != null) {
				...
				pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "JoelC2"));
			}
		}
