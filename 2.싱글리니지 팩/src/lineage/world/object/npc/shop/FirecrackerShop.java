...
public class FirecrackerShop extends ShopInstance {
	
	public FirecrackerShop(Npc npc){
		super(npc);
	...
	public void toTalk(PcInstance pc, ClientBasePacket cbp){
		...
		switch(getNpc().getNameIdNumber()){
			case 1639:	// 모모
				pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "momo1"));
				break;
		}
	}
	...
	public void toTalk(PcInstance pc, String action, String type, ClientBasePacket cbp) {
		...
		if (action.equalsIgnoreCase("buy")) {
			...
			if (sell_list.size() > 0) {
				...
				pc.toSender(S_Html.clone(BasePacketPooling.getPool(S_Html.class), this, "momo2"));
			}
